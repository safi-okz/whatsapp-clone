    ...
    <div class="ml-[420px] w-full">
       <div class="w-full">
            ...
            <div class="border-l border-green-500 w-full">
                <div class="bg-[#f0f0f0] fixed z-10 min-w-[calc(100vw-420px)] flex justify-between items-center px-2 py-2">
                    <div class="flex items-center">
                        <img class="rounded-full mx-1 w-10 h-10" v-if="userDataForChat[0] && userDataForChat[0].picture" :src="userDataForChat[0].picture" alt="">
            ...
            <div id="MessageSection" class="pt-20 pb-8 z-[-1] h-[calc(100vh-65px)] w-[calc(100vw-420px)] overflow-auto fixed touch-auto">
                ...
                <div v-else class="flex justify-end spacex-1 w-[calc(100%-50px)] float-right">
            ...
            <div class="w-[calc(100vw-420px)] p-2.5 z-10 bg-[#f0f0f0] fixed bottom-0">
                <div class="flex items-center justify-center">
                    <EmoticonExitedOutlineIcon :size="27" fillColor="#515151" class="mx-1.5" />
                    <PaperclipIcon :size="27" fillColor="#515151" class="mx-1.5 mr-3" />
                    <input v-model="message" type="text" class="mr-1 rounded-lg shadow apperance-none w-full py-3 px-4 
...
import EmoticonExitedOutlineIcon from 'vue-material-design-icons/EmoticonExcitedOutline.vue';
...
watch(() => currentChat.value, (chat) => {
    if(chat.length){
        setTimeout(() => {
            let objDiv = document.getElementById('MessageSection');
